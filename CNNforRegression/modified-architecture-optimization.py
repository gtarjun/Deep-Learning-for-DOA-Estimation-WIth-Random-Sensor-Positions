            ...
            for convolution_layer_2 in convolution_layers_2:
                for convolution_layer_3 in convolution_layers_3:
                    for size_layer_convolution in layer_sizes_convolution:
                        ...
                        model_architecture = "{}denselayer-{}layer_size_dense-{}convlayer1-{}convlayer2-{}convlayer3-{}layer_size_conv-{}".format(dense_layer,size_layer_dense,convolution_layer_1,convolution_layer_2,convolution_layer_3,size_layer_convolution,int(time.time()))
